...
import com.example.workoutselector.backend.firebase.ExerciseDAO;
import com.example.workoutselector.backend.firebase.ExerciseGroupDAO;
import com.example.workoutselector.backend.firebase.WorkoutDAO;
import com.example.workoutselector.frontend.adapters.DescriptionItem;
...
import com.example.workoutselector.frontend.adapters.WorkoutElement;
...
public class WorkoutView extends ConstraintLayout {
    ...
    private void initExercisesList() {
        ...
        exerciseFakeList.add(new ExerciseItem("Crunches", "5", false, false));
